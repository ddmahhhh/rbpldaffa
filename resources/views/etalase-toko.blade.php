                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('foto_barang/' . $item->foto_barang) }}"
                                class="img-thumbnail mb-4 object-fit-cover border rounded" alt="" width="150px"
                                height="150px">
                            <p class="mt-1">{{ $item->deskripsi_barang }}</p>
                            <a href="/update-barang/{{ $item->id }}" class="btn btn-outline-dark">Edit</a>
                            <a href="#" onclick="confirmation(event)" class="btn btn-outline-danger delete"
                                item-id="{{ $item->id }}" item-name="{{ $item->nama_barang }}">Hapus</a>
                        </div>
                    </div>
                </div>
            @endforeach
