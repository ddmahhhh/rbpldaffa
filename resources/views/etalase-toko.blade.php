...
<head>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-links">
            ...
            <li><a href="/bandind">Bandingkan Harga</a></li>
        </ul>
                    ...
                    <div class="col-2">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <a href="/delete-barang/{{ $item->id }}" onclick="confirmation(event)" class="btn btn-outline-danger delete" item-id=" $item->id  }}" item-name="{{ $item->nama_barang  }}">Hapus</a>
                            </div>
                        </div>
                    </div>
                @endforeach
